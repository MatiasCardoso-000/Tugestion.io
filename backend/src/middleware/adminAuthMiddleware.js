...
export var adminAuthMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id, userResult, userRole, error_1;
    var _a;
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                if (userRole !== 'admin') {
                    ...
                    return [2 /*return*/, res.status(403).json({ message: 'Acceso denegado. Se requiere rol de administrador.' })];
                }
