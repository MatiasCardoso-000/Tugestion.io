 ...
 */
var add = function (token) { return __awaiter(void 0, void 0, void 0, function () {
    var query, rows;
 ...
 */
var find = function (token) { return __awaiter(void 0, void 0, void 0, function () {
    var query, rows;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
export var TokenBlackListModel = {
    add: add,
    find: find
};
