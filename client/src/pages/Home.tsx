    ...
    <div className="min-h-screen bg-zinc-50 flex flex-col font-sans text-zinc-900">
      ...
      <nav className="w-full max-w-7xl mx-auto px-6 py-6 flex justify-between items-center">
        ...
        <div className="flex gap-4">
          <Link
            to="/login"
            className="px-5 py-2 text-sm font-semibold text-zinc-600 hover:text-red-600 transition-colors"
          >
            Iniciar sesión
          </Link>
          <Link
      ...
      <header className="flex-1 flex flex-col items-center justify-center text-center px-4 mt-12 mb-20">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-50 text-red-700 text-xs font-bold uppercase tracking-wider mb-6 border border-red-100">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          <Link
            to="/register"
            className="group flex items-center justify-center gap-2 px-8 py-4 bg-red-600 text-white rounded-xl font-bold text-lg hover:bg-red-700 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1"
          >
            Comenzar Gratis
      ...
      <section className="bg-white py-24 border-t border-zinc-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-12">
            <div className="p-6 rounded-2xl bg-zinc-50 border border-zinc-100 hover:border-red-100 hover:shadow-lg transition-all duration-300">
