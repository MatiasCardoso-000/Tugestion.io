// Agrega aquí más iconos según los vayas encontrando en la app
...
export const SquarePenIcon = ({ styleType }: { styleType: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      className={`lucide lucide-square-pen-icon lucide-square-pen ${styleType}`}
    >
...
export const ArrowUpIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-arrow-up-icon lucide-arrow-up"><path d="m5 12 7-7 7 7" /><path d="M12 19V5" /></svg>
  )
}
...
export const HamburguerIcon = () => {
  return (
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      className="lucide lucide-menu-icon lucide-menu cursor-pointer"
    >
      <path d="M4 12h16" />
      <path d="M4 18h16" />
      <path d="M4 6h16" />
...
export const BusIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-bus-front">
    <path d="M4 6 2 7" /><path d="M10 6h4" /><path d="m22 7-2-1" /><rect width="16" height="16" x="4" y="3" rx="2" /><path d="M4 11h16" /><path d="M8 15h.01" /><path d="M16 15h.01" /><path d="M6 19v2" /><path d="M18 19v2" />
  </svg>
);
