  ...
  return (
    ...
    >
      <Input
        ...
        value={inputValue}
      />
      <Button buttonStyle="w-1/11 py-3 bg-white ring-2 ring-zinc-900 text-zinc-900 rounded-lg font-bold text-lg cursor-pointer shadow-md hover:bg-zinc-800 hover:text-white transition-colors mt-2">
        Buscar
      </Button>
    </Form>
  );
